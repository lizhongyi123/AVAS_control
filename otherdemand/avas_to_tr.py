...
def tran_avas_tracewin_list(avas_list):
    ...
    for index, stat in enumerate(avas_list):
        if len(stat) == 0:
            ...
            tmp = [stat[0].lower(), stat[1]*1000, 0, 0, 0]
...
if __name__ == '__main__':
    ...
    # res = field_tmp_to_stat(fiels)
    # print(res)
    avas_path = r"C:\Users\wangh\Desktop\avtrtr\avas_lattice.txt"
    tracewin_lattice_path = r"C:\Users\wangh\Desktop\avtrtr\lattice.dat"
