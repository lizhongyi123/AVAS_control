...
if __name__ == "__main__":
    #读取原来的分布
    ori_dst = r"C:\Users\wangh\Desktop\2brfq\2brfq\inputFile\part_input.dst"
...
######################
    #修改参数
    new_fenbu["ib"] = 20
    new_fenbu["freq"] = 750 #换算单位 Mhz到hz

    #生成新的分布
    new_dst = r"C:\Users\wangh\Desktop\2brfq\2brfq\inputFile\part_input2.dst"
